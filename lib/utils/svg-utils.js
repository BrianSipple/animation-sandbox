...
/**
 * Set the filter property for an element
 */
function setFilterPathOnElem (element, filterPath) {
    element.setAttribute('filter', `url(${filterPath})`);
}

/**
 * Remove the filter property of an element
 */
function removeFilterFromElem (element) {
